### [BaseMultivariateDistribution](BaseMultivariateDistribution.md).distribution (method)
...
* `x` (array): x-values at which to compute the densities.  If `unit` is
    ...
    [BaseMultivariateDistribution.unit](BaseMultivariateDistribution.unit.md), not `unit`.
