### [Composite](Composite.md).sample_uncertainties_formatted (function)
...
[Composite.sample_quantiles](Composite.sample_quantiles.md) using scipy.state.norm.cdf([`-sigma`, `0`, `sigma`])
and then formats those into a Latex friendly representation.

See also:
* [Composite.sample_quantiles](Composite.sample_quantiles.md)
