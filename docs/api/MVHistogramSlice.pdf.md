### [MVHistogramSlice](MVHistogramSlice.md).pdf (function)
...
See also:
* [MVHistogramSlice.logpdf](MVHistogramSlice.logpdf.md)
* [MVHistogramSlice.cdf](MVHistogramSlice.cdf.md)

Arguments
----------
* `x` (float or array, optional, default=None): x-values at which to
    expose the pdf.  If None or not provided, [MVHistogramSlice.cached_sample](MVHistogramSlice.cached_sample.md)
