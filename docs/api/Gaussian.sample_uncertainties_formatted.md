### [Gaussian](Gaussian.md).sample_uncertainties_formatted (function)
...
[Gaussian.sample_quantiles](Gaussian.sample_quantiles.md) using scipy.state.norm.cdf([`-sigma`, `0`, `sigma`])
and then formats those into a Latex friendly representation.

See also:
* [Gaussian.sample_quantiles](Gaussian.sample_quantiles.md)
