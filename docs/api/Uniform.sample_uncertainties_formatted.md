### [Uniform](Uniform.md).sample_uncertainties_formatted (function)
...
[Uniform.sample_quantiles](Uniform.sample_quantiles.md) using scipy.state.norm.cdf([`-sigma`, `0`, `sigma`])
and then formats those into a Latex friendly representation.

See also:
* [Uniform.sample_quantiles](Uniform.sample_quantiles.md)
