### [Delta](Delta.md).sample_uncertainties_formatted (function)
...
[Delta.sample_quantiles](Delta.sample_quantiles.md) using scipy.state.norm.cdf([`-sigma`, `0`, `sigma`])
and then formats those into a Latex friendly representation.

See also:
* [Delta.sample_quantiles](Delta.sample_quantiles.md)
...
* `samples` (array-type, optional, default=None): samples to use.  If
    not provided, [Delta.sample](Delta.sample.md) will be called with `size=1e6`.
