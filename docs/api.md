...
* [delta_around](api/distl.delta_around.md)
...
* [gaussian_around](api/distl.gaussian_around.md)
...
* [MVSamplesSlice](api/MVSamplesSlice.md)
* [Uniform](api/Uniform.md)
* [Uniform_Around](api/Uniform_Around.md)
